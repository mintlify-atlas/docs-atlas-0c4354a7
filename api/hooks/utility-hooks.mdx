...
<ParamField path="version" type="number" default="3034">
  Bible version ID
</ParamField>

<ParamField path="book" type="string" default="GEN">
  USFM book abbreviation
</ParamField>

<ParamField path="chapter" type="number" default="1">
  Chapter number
</ParamField>
...
<ResponseField name="data" type="InitData | null">
  Object containing version, book, and chapter data when all are loaded
  
  <Expandable title="InitData properties">
    <ResponseField name="version" type="BibleVersion">
      Version metadata
    </ResponseField>
    <ResponseField name="book" type="BibleBook">
      Book metadata with chapters
    </ResponseField>
    <ResponseField name="chapter" type="BibleChapter">
      Chapter content
    </ResponseField>
  </Expandable>
</ResponseField>
