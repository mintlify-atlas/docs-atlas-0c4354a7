...
<ParamField path="books" type="BibleBook[]" required>
  Ordered array of Bible books with populated chapters
</ParamField>

<ParamField path="currentBookId" type="string" required>
  USFM book ID (e.g., "JHN", "GEN", "REV")
</ParamField>

<ParamField path="currentChapterId" type="string" required>
  Chapter ID string (e.g., "1", "2", "INTRO")
</ParamField>

<ParamField path="direction" type="'next' | 'previous'" required>
  Navigation direction
</ParamField>

**Returns:** `{ bookId: string; chapterId: string } | null`
